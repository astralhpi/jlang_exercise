...
def fib(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    ...
    if (_coconut.len(_coconut_match_to_args) == 1) and (_coconut_match_to_args[0] == 1):
        if not _coconut_match_to_kwargs:
            _coconut_match_check = True
    if not _coconut_match_check:
        _coconut_match_err = _coconut_MatchError("pattern-matching failed for " "'def fib(1) = 1'" " in " + _coconut.repr(_coconut.repr(_coconut_match_to_args)))
        _coconut_match_err.pattern = 'def fib(1) = 1'
...
def fib(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    _coconut_match_check = False
    if (_coconut.len(_coconut_match_to_args) == 1) and (_coconut_match_to_args[0] == 2):
        if not _coconut_match_to_kwargs:
            _coconut_match_check = True
    if not _coconut_match_check:
        _coconut_match_err = _coconut_MatchError("pattern-matching failed for " "'def fib(2) = 1'" " in " + _coconut.repr(_coconut.repr(_coconut_match_to_args)))
        _coconut_match_err.pattern = 'def fib(2) = 1'
        _coconut_match_err.value = _coconut_match_to_args
        raise _coconut_match_err
...
def fib(*_coconut_match_to_args, **_coconut_match_to_kwargs):
    ...
    if _coconut_match_check and not (n > 2):
        _coconut_match_check = False
    if not _coconut_match_check:
        _coconut_match_err = _coconut_MatchError("pattern-matching failed for " "'def fib(n is int if n > 2) = fib(n-1) + fib(n-2)'" " in " + _coconut.repr(_coconut.repr(_coconut_match_to_args)))
        _coconut_match_err.pattern = 'def fib(n is int if n > 2) = fib(n-1) + fib(n-2)'
        _coconut_match_err.value = _coconut_match_to_args
        raise _coconut_match_err
